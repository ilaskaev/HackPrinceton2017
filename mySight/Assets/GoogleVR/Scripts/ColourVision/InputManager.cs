// Mostly taken from the Google VR Demos DemoInputManager.cs
...
public class InputManager : MonoBehaviour
{
    ...
    public static string EMULATED_PLATFORMPROP_NAME = "gvrEmulatedPlatformType";
#else
    ...
    void Start () {
        ...
        // Message canvas will be enabled later when it is needed
    ...
    {
        if (!playerSettingsHasCardboard() && !playerSettingsHasDaydream())
        {
            return;
        }

        // Player Settings > VR SDK list ay have changed at runtime. The emulated platform
